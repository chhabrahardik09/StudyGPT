...
//   });
// };
export default function CoursePage4() {
  const [text, setText] = useState("");
  const [input, setInput] = useState("Intro to Cyber Security");
  ...
  const onClick = (e) => {
    if (e.key === "courseWork1") {
      setInput("Intro to Cyber Security");
      setTab("Course Work");
    } else if (e.key === "quiz1") {
      setInput("Ask me a question on Intro to Cyber Security");
      setTab("quiz1");
    } else if (e.key === "courseWork2") {
      setInput("Intro to Cryptography");
      setTab("courseWork2");
    } 
    else if(e.key === "quiz2"){
      setInput("Ask me a question on Cryptography");
      setTab("quiz2");
    } else if(e.key === "courseWork3"){
      setInput("Cyber Forensics");
      setTab("courseWork3");
    }else if(e.key === "quiz3"){
      setInput("Ask me a question on Cyber Forensics");
      setTab("quiz3");
    }else if(e.key === "courseWork4"){
      setInput("Cyber ethics");
      setTab("courseWork4");
    }
    else if(e.key === "quiz4"){
      setInput("Ask me a question on Cyber ethics");
      setTab("quiz4");
    }
    console.log("click ", e);
  };
...
const items = [
  getItem("Intro to Cyber Security", "sub1", <BugOutlined />, [
    getItem("Course Work", "courseWork1", null),
    getItem("Quiz", "quiz1", null),
  ]),
  getItem("Cryptography", "sub2", <BugOutlined />, [
  ...
  getItem("Cyber Forensics", "sub4", <BugOutlined />, [
    getItem("Course Work","courseWork3", null),
    getItem("Quiz", "quiz3", null),
    
  ]),
  getItem("Cyber ethics", "sub5", <BugOutlined />, [
