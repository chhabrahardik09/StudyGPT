...
export default function CoursePage() {
  const [text, setText] = useState("");
  const [input, setInput] = useState("Intro to ML");
  ...
  const onClick = (e) => {
    if (e.key === "courseWork1") {
      setInput("Intro to ML");
      setTab("courseWork1");
    } else if (e.key === "quiz1") {
      setInput("Ask me a question on Intro to ML");
      setTab("quiz1");
    } else if(e.key === "courseWork2") {
      setInput("Steps in ML Training");
      setTab("courseWork2");
    }
    else if(e.key === "quiz2") {
      setInput("Ask me a question on Steps in ML Training");
      setTab("quiz2");
    }
    else if(e.key === "courseWork3") {
      setInput("Data collection process in ML");
      setTab("courseWork3");
    }
    else if(e.key === "quiz3") {
      setInput("Ask me a question on data collected in ML");
      setTab("quiz3");
    }
    else if(e.key === "courseWork4") {
      setInput("Pre-processing in ML");
      setTab("courseWork4");
    }
    else if(e.key === "quiz4") {
      setInput("Ask me a question on how Pre-processing is done in ML");
      setTab("quiz4");
    }
...
const items = [
  getItem("Intro to ML", "sub1", <SettingOutlined />, [
    getItem("Course Work", "courseWork1", null),
    getItem("Quiz", "quiz1", null),
  ]),
  getItem("Steps in ML training", "sub2", <SettingOutlined />, [
  ...
  getItem("Data Collection in ML", "sub4", <SettingOutlined />, [
    getItem("Course Work","courseWork3", null),
    getItem("Quiz", "quiz3", null),
    
  ]),
  getItem("Pre-processing", "sub5", <SettingOutlined />, [
