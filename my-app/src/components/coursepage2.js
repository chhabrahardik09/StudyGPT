...
export default function CoursePage2() {
  const [text, setText] = useState("");
  const [input, setInput] = useState("Intro to Cloud Computing");
  ...
  const onClick = (e) => {
    if (e.key === "courseWork1") {
      setInput("Intro to Cloud computing");
      setTab("Course Work");
    } else if (e.key === "quiz1") {
      setInput("Ask me a question on Intro to Cloud Computing");
      setTab("quiz1");
    } else if (e.key === "courseWork2") {
      setInput("Cloud Service Models");
      setTab("courseWork2");
    } else if (e.key === "quiz2") {
      setInput("Ask me a question on Cloud Service Models");
      setTab("quiz2");
    } else if (e.key === "courseWork3") {
      setInput("Cloud Security");
      setTab("courseWork3");
    } else if (e.key === "quiz3") {
      setInput("Ask me a question on Cloud Security");
      setTab("quiz3");
    } else if (e.key === "courseWork4") {
      setInput("Cloud Networking");
      setTab("courseWork4");
    } else if (e.key === "quiz4") {
      setInput("Ask me a question on Cloud Networking");
      setTab("quiz4");
    }
...
const items = [
  getItem("Intro to Cloud Computing", "sub1", <CloudOutlined />, [
    getItem("Course Work", "courseWork1", null),
    getItem("Quiz", "quiz1", null),
  ]),
  getItem("Cloud Service Models", "sub2", <CloudOutlined />, [
  ...
  getItem("Cloud Security", "sub4", <CloudOutlined />, [
    getItem("Course Work", "courseWork3", null),
    getItem("Quiz", "quiz3", null),
  ]),
  getItem("Cloud Networking", "sub5", <CloudOutlined />, [
